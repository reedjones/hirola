...
class Thread(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("messages-single-thread", args=[self.pk])
...
class Message(models.Model):
    ...
    @classmethod
    def new_message(cls, from_user, to_users, content, subject=""):
        """
        ...
        """
        if not subject:
            subject = (content[:15] + "...") if len(content) > 15 else content
